...
import tokyo.peya.obfuscator.processors.flowObfuscation.FlowObfuscator;
import tokyo.peya.obfuscator.processors.name.INameObfuscationProcessor;
import tokyo.peya.obfuscator.processors.name.InnerClassRemover;
import tokyo.peya.obfuscator.processors.name.NameObfuscation;
import tokyo.peya.obfuscator.processors.optimizer.Optimizer;
